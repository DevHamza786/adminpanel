...
import AddSmileys from './add-simpleys.vue';
...
const isAddSmileysVisible = ref(false)
...
<template>
  <section>
        ...
        <VCard title="All Smileys">
          <VCardText class="d-flex flex-wrap gap-4">
            ...
            <div class="app-user-search-filter d-flex align-center">
              ...
              <!-- 👉 Add Smileys button -->
              <VBtn @click="isAddSmileysVisible = true">
                Add Smileys
              </VBtn>
            </div>
          </VCardText>
    ...
    <!-- 👉 Add New User -->
    <AddSmileys
      v-model:isDrawerOpen="isAddSmileysVisible"
