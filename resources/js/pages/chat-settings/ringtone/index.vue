...
import AddRingTone from './add-ringtone.vue'
...
const isAddRingToneVisible = ref(false)
...
<template>
  <section>
        ...
        <VCard title="All RingTone">
          <VCardText class="d-flex flex-wrap gap-4">
            ...
            <div class="app-user-search-filter d-flex align-center">
              ...
              <!-- 👉 Add RingTone button -->
              <VBtn @click="isAddRingToneVisible = true">
                Add RingTone
              </VBtn>
            </div>
          </VCardText>
    ...
    <!-- 👉 Add New User -->
    <AddRingTone
      v-model:isDrawerOpen="isAddRingToneVisible"
