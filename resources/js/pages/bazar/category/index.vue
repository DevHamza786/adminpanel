...
import AddSubCategory from './add-sub-category.vue';
...
const isAddSubCategoryVisible = ref(false)
...
<template>
  <section>
        ...
        <VCard title="All Category">
          <VCardText class="d-flex flex-wrap gap-4">
            ...
            <div class="app-user-search-filter d-flex align-center">
              ...
              <VSpacer />
              <!-- 👉 Add Category button -->
              <VBtn @click="isAddSubCategoryVisible = true">
                Add Sub Category
              </VBtn>
            </div>
          </VCardText>
    ...
    />
    <AddSubCategory
      v-model:isDrawerOpen="isAddSubCategoryVisible"
      @user-data="addNewUser"
    />
  </section>
</template>
