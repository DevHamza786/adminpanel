...
import NewBazar from './add-bazar.vue';
...
const isAddBazarDrawerVisible = ref(false)
...
<template>
  <section>
        ...
        <VCard title="All Bazar">
          ...
          <VCardText class="d-flex flex-wrap gap-4">
            ...
            <div class="app-user-search-filter d-flex align-center">
              ...
              <!-- 👉 Add Bazar button -->
              <VBtn @click="isAddBazarDrawerVisible = true">
                Add Bazar
              </VBtn>
            </div>
          </VCardText>
    ...
    <!-- 👉 Add New User -->
    <NewBazar
      v-model:isDrawerOpen="isAddBazarDrawerVisible"
