...
import AddVote from './add-vote.vue'
...
const isAddVoteVisible = ref(false)
...
<template>
  <section>
        ...
        <VCard title="Voting List">
          <VCardText class="d-flex flex-wrap gap-4">
            ...
            <div class="app-user-search-filter d-flex align-center">
              ...
              <!-- 👉 Add Vote button -->
              <VBtn @click="isAddVoteVisible = true">
                Add Vote
              </VBtn>
            </div>
          </VCardText>
    ...
    <!-- 👉 Add New User -->
    <AddVote
      v-model:isDrawerOpen="isAddVoteVisible"
