...
import AddAlbum from './add-album.vue';
...
const isAddAlbumVisible = ref(false)
...
<template>
  <section>
        ...
        <VCard title="All Album">
          <VCardText class="d-flex flex-wrap gap-4">
            ...
            <div class="app-user-search-filter d-flex align-center">
              ...
              <!-- 👉 Add Album button -->
              <VBtn @click="isAddAlbumVisible = true">
                Add Album
              </VBtn>
            </div>
          </VCardText>
    ...
    <!-- 👉 Add New User -->
    <AddAlbum
      v-model:isDrawerOpen="isAddAlbumVisible"
