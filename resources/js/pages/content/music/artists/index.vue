...
import AddArtist from './add-artists.vue';
...
const isAddArtistVisible = ref(false)
...
<template>
  <section>
        ...
        <VCard title="All Artists">
          <VCardText class="d-flex flex-wrap gap-4">
            ...
            <div class="app-user-search-filter d-flex align-center">
              ...
              <!-- 👉 Add Artists button -->
              <VBtn @click="isAddArtistVisible = true">
                Add Artists
              </VBtn>
            </div>
          </VCardText>
    ...
    <!-- 👉 Add New User -->
    <AddArtist
      v-model:isDrawerOpen="isAddArtistVisible"
