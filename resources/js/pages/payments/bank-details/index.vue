...
import AddMusic from './add-bank.vue';
...
const isAddMusicVisible = ref(false)
...
<template>
  <section>
        ...
        <VCard title="All Bank Transfer">
          <VCardText class="d-flex flex-wrap gap-4">
            ...
            <div class="app-user-search-filter d-flex align-center">
              ...
              <VTextField
                v-model="searchQuery"
                placeholder="Search Bank Transfer"
                density="compact"
                class="me-3"
              />

              <!-- 👉 Add Music button -->
              <VBtn @click="isAddMusicVisible = true">
                Add Bank
              </VBtn>
            </div>
          </VCardText>
    ...
    <!-- 👉 Add New User -->
    <AddMusic
      v-model:isDrawerOpen="isAddMusicVisible"
