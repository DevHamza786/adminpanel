...
import AddServices from './add-services.vue';
...
const isAddServicesVisible = ref(false)
...
<template>
  <section>
        ...
        <VCard title="All VIP Services">
          <VCardText class="d-flex flex-wrap gap-4">
            ...
            <div class="app-user-search-filter d-flex align-center">
              ...
              <!-- 👉 Add Services button -->
              <VBtn @click="isAddServicesVisible = true">
                Add Services
              </VBtn>
            </div>
          </VCardText>
    ...
    <!-- 👉 Add New User -->
    <AddServices
      v-model:isDrawerOpen="isAddServicesVisible"
